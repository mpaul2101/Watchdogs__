...
CREATE TABLE IF NOT EXISTS users (
    ...
    role VARCHAR(20) CHECK (role IN ('engineer', 'admin')) NOT NULL,
    password_hash TEXT
);

-- Seed data for demo impersonation
INSERT INTO users (username, email, role, password_hash)
VALUES
    ('admin_user', 'admin@watchdogs.local', 'admin', '$2b$12$3KTZ1AvDJ5ooZ.vt04hLhevLDcjUyz3MO6J2SMCaV8SUhfM69wdHS'),
    ('eng_paul', 'paul@watchdogs.local', 'engineer', '$2b$12$3KTZ1AvDJ5ooZ.vt04hLhevLDcjUyz3MO6J2SMCaV8SUhfM69wdHS'),
    ('eng_ana', 'ana@watchdogs.local', 'engineer', '$2b$12$3KTZ1AvDJ5ooZ.vt04hLhevLDcjUyz3MO6J2SMCaV8SUhfM69wdHS')
...
CREATE INDEX IF NOT EXISTS idx_alarms_assignee_id ON alarms (assignee_id);
...
CREATE INDEX IF NOT EXISTS idx_incidents_assignee_id
